 ...
 */
#ifndef FCITX_AVRO_PROBHAT_KEYMAP_H
#define FCITX_AVRO_PROBHAT_KEYMAP_H

#include <cctype>
#include <cstring>

namespace fcitx::avro {

// OpenBangla Probhat.json normal (lowercase) and shift (uppercase) layers.
